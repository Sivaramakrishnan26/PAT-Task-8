CREATE DATABASE IMDB;  -- Create a DB
USE IMDB;  -- Use the Created DB

CREATE TABLE Movie  -- Create a Table Movie with the below Columns
(
...
CREATE TABLE Media  -- Create a Table Media with the below Columns
(
